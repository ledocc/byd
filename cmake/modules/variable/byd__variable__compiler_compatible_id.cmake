...
function(__byd__variable__compiler_compatible_id__get_id result lang)
    ...
    elseif("${CMAKE_${lang}_COMPILER_ID}" STREQUAL "MSVC")
        string( REGEX MATCH "^[0-9]+" MSVC_MAJOR_VERSION ${CMAKE_${lang}_COMPILER_VERSION} )
        set(id ${CMAKE_${lang}_COMPILER_ID}__${MSVC_MAJOR_VERSION})
    elseif("${CMAKE_${lang}_COMPILER_ID}" STREQUAL "Clang")
        if( ( "-stdlib=libc++" IN_LIST CMAKE_CXX_FLAGS ) OR ( CMAKE_SYSTEM_NAME STREQUAL "Darwin" ) )
            set(id "Clang-libc++")
        else()
            set(id "GNU")
        endif()
