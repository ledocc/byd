...
function(__byd__BoostBuild__script__generate_user_config_jam)
    ...
    cmut__utils__cmake_cxx_standard_to_compiler_option(cxx_standard_option)
    byd__script__write("<cxxflags>\"${CMAKE_CXX_FLAGS} ${cxx_standard_option}\"")
    if(APPLE)
        if(NOT CMAKE_OSX_SYSROOT STREQUAL "")
            byd__script__write("<cflags>\"-isysroot ${CMAKE_OSX_SYSROOT}\"")
            byd__script__write("<cxxflags>\"-isysroot ${CMAKE_OSX_SYSROOT}\"")
            byd__script__write("<linkflags>\"-isysroot ${CMAKE_OSX_SYSROOT}\"")
        endif()
        if(NOT CMAKE_OSX_DEPLOYMENT_TARGET STREQUAL "")
            byd__script__write("<cflags>\"-mmacosx-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET}\"")
            byd__script__write("<cxxflags>\"-mmacosx-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET}\"")
            byd__script__write("<linkflags>\"-mmacosx-version-min=${CMAKE_OSX_DEPLOYMENT_TARGET}\"")
        endif()
    endif()
